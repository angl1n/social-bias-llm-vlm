...
| Title | Introduction | Date | Code |
| :--- | :---: | :---: | :---: |
| [![Publish](https://img.shields.io/badge/Journal-Information%20Processing%20%26%20Management'26-blue)]()<br/>[Performance unfairness of large language models in cross-language fact-checking](https://doi.org/10.1016/j.ipm.2026.104616) | <img width="700" alt="image" src="figures/PerformanceUnfairness_CrossLanguageFactChecking.png">| 2026-06 | - |
...
| [![Publish](https://img.shields.io/badge/Conference-ICLR'26_Poster-blue)]()<br/>[Vision Language Models are Biased](https://arxiv.org/pdf/2505.23941.pdf) | <img width="700" alt="image" src="figures/VisionLanguageModelsAreBiased.png">| 2026-01 | [Code](https://vlmsarebiased.github.io/) |
...
| [![Publish](https://img.shields.io/badge/Conference-Findings%20of%20EMNLP'25-blue)]()<br/>[Evaluating Fairness in Large Vision-Language Models Across Diverse Demographic Attributes and Prompts](https://aclanthology.org/2025.findings-emnlp.1251.pdf) | <img width="700" alt="image" src="figures/EvaluatingFairness_LVLM_DemographicsPrompts.png">| 2025-11 | - |
...
| [HumaniBench: A Human-Centric Framework for Large Multimodal Models Evaluation](https://arxiv.org/pdf/2505.11454.pdf) | <img width="700" alt="image" src="figures/HumaniBench.png">| 2025-05 | [Github](https://github.com/VectorInstitute/humanibench) |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS'24-blue)]()<br/>[MultiTrust: A Comprehensive Benchmark Towards Trustworthy Multimodal Large Language Models](https://arxiv.org/pdf/2406.07057.pdf) | <img width="700" alt="image" src="figures/MultiTrust.png">| 2024-12 | [Code](https://multi-trust.github.io/) |
...
| [FMBench: Benchmarking Fairness in Multimodal Large Language Models on Medical Tasks](https://arxiv.org/pdf/2410.01089.pdf) | <img width="700" alt="image" src="figures/FMBench_MedicalTasks.png">| 2024-10 | - |
...
| [![Publish](https://img.shields.io/badge/Conference-CVPR'25-blue)]()<br/>[Joint Vision-Language Social Bias Removal for CLIP](https://openaccess.thecvf.com/content/CVPR2025/papers/Zhang_Joint_Vision-Language_Social_Bias_Removal_for_CLIP_CVPR_2025_paper.pdf) | <img width="700" alt="image" src="figures/JointVLSocialBiasRemoval_CLIP.png">| 2025-06 | [Github](https://github.com/haoyusimon/VL_Debiasing) |
...
| Title | Introduction | Date | Code |
| :--- | :---: | :---: | :---: |
| [Biases in the Blind Spot: Detecting What LLMs Fail to Mention](https://arxiv.org/pdf/2602.10117.pdf) | <img width="700" alt="image" src="figures/BiasesInTheBlindSpot_DetectingWhatLLMsFailToMention.png">| 2026-02 | - |
| [FairReason: Balancing Reasoning and Social Bias in MLLMs](https://arxiv.org/pdf/2507.23067.pdf) | <img width="700" alt="image" src="figures/FairReason.png">| 2025-09 | [Github](https://github.com/Yutongzhang20080108/FairReason-Balancing-Reasoning-and-Social-Bias-in-MLLMs) |
| [![Publish](https://img.shields.io/badge/Journal-Health%20Data%20Science'25-blue)]()<br/>[Evaluating Sex and Age Biases in Multimodal Large Language Models for Skin Disease Identification from Dermatoscopic Images](https://spj.science.org/doi/pdf/10.34133/hds.0256) | <img width="700" alt="image" src="figures/SkinDiseaseIdentification_SexAgeBias.png">| 2025-04 | - |
...
| [![Publish](https://img.shields.io/badge/Conference-ACL'24-blue)]()<br/>[Large Language Models are not Fair Evaluators](https://aclanthology.org/2024.acl-long.511.pdf) | <img width="700" alt="image" src="figures/LLMsAreNotFairEvaluators.png">| 2024-07 | [Github](https://github.com/i-Eval/FairEval) |
